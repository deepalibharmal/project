...
$y=$_POST['y'];
 ...
 echo $creditno;
      $sqlinsert="INSERT INTO user( username, password, address, state, city, pincode, gender, dob, creditno ) VALUES ( '$username',  '$password', '$address ', '$state', '$city', '$zipcode', '$gender', '$y.$m.$d', '$creditno' )";
    ...
    if(isNumeric(zip, "Please enter a valid numeric PIN code..")){
     if(madeSelection(state, "Please Choose a State from the options..")){
	  if(emailValidator(email, "Please enter a valid email address..")) {
         if(lengthRestrictioncr(credit, 10, 10)){
...
<tr> <td><b>CREDIT CARD NO:</b></td>
	...
	<tr> <td> <label><input type="submit" name="Submit" value="Submit" /></label></td></tr>
</table></form></td></table> 
